...
const Hero = () => {
  return (
    ...
    <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
     ...
     width={50}
     height={50}
     className="absolute left-[-5px] top-[-30px] w-10 kg:w-[50px]"
     />
     <h1 className="bold-52 lg:bold-88">Putuk Truno Camp Area</h1>
     <p className="regular-16 mt-6 text-gray-30 xl:max-w-[520px]">
      We want to be on each of your journeys seeking the 
      satisfaction of seeing the incorreutible beauty of nature. we 
    ...
    <div className="relative flex flex-1 items-start ">
     <div className="relative z-20 flex w-[268px] flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8">
      <div className="flex flex-col">
       ...
       <p className="bold-20 text-white">Agaus claientes</p>
       </div>
       <div className="flexBetween">
         <div className="flex flex-col">
